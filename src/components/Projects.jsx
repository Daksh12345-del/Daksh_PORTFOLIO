...
export const PROJECTS = [
  {
    ...
    impact: 'Live job aggregator (9 sources) · 6-platform DSA tracker',
    desc: 'Founded and built GradeWallah — a full-stack SaaS for engineering students to track SGPA/CGPA, follow a DSA roadmap synced across 6 competitive-coding platforms, and discover internships & placements aggregated live from 9+ job sources. A Python/FastAPI backend runs a daily concurrent sync, validates every listing with Pydantic, and caches to Supabase so the site never scrapes on request — backed by an AI Career Coach (Groq) and CGPA/DSA leaderboards.',
    tags: ['React', 'Python', 'Supabase'],
    stack: ['React 19', 'Vite', 'Clerk', 'Python (FastAPI)', 'aiohttp', 'Supabase (PostgreSQL)', 'Pydantic', 'Pytest', 'Vercel'],
    features: [
      'SGPA/CGPA calculator with back-paper logic across all 8 semesters',
      'DSA Tracker synced across LeetCode, Codeforces, CodeChef, GeeksforGeeks, HackerRank & GitHub',
      'Live internship & placement aggregation from 9+ sources (JSearch, Adzuna, Internshala, Remotive, TheMuse & more)',
      'CGPA & DSA leaderboards to compare rank with peers',
      'AI Career Coach powered by Groq for personalized guidance',
      'Clerk auth with Google/GitHub OAuth + reCAPTCHA bot protection',
      'Async Python/FastAPI backend — daily concurrent sync, SSRF guard, per-IP rate limiting',
      '240+ backend tests (~90% coverage), CI on every push via GitHub Actions',
    ],
    live: 'https://www.gradewallah.com',
    github: 'https://github.com/Daksh12345-del/GRADEWISE_PROJECT.git',
    githubBackend: 'https://github.com/Daksh12345-del/gradewise-backend.git',
  },
  {
